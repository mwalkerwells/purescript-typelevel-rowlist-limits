...
-- Two
instance twoConsLimitCountTwo  :: LimitCount (Pos (Succ (Succ Z)))
  (Cons l1 t1
    (Cons l2 t2 Nil)
  )
else
...
-- Three
instance threeConsLimitCountThree  :: LimitCount (Pos (Succ (Succ (Succ Z))))
  (Cons l1 t1
    (Cons l2 t2
      (Cons l3 t3 Nil)
  ))
...
-- Four
instance fourConsLimitCountFour  :: LimitCount (Pos (Succ (Succ (Succ (Succ Z)))))
  (Cons l1 t1
    (Cons l2 t2
      (Cons l3 t3
        (Cons l4 t4 Nil)
...
-- Five
instance fiveConsLimitCountFive  :: LimitCount (Pos (Succ (Succ (Succ (Succ (Succ Z))))))
  (Cons l1 t1
    (Cons l2 t2
      (Cons l3 t3
        (Cons l4 t4
...
-- Six
instance sixConsLimitCountSix  :: LimitCount (Pos (Succ (Succ (Succ (Succ (Succ (Succ Z)))))))
  (Cons l1 t1
    (Cons l2 t2
      (Cons l3 t3
        (Cons l4 t4
...
-- Seven
instance sevenConsLimitCountSeven  :: LimitCount (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ Z))))))))
  (Cons l1 t1
    (Cons l2 t2
      (Cons l3 t3
        (Cons l4 t4
...
-- Eight
instance eightConsLimitCountEight  :: LimitCount (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Z)))))))))
  (Cons l1 t1
    (Cons l2 t2
      (Cons l3 t3
        (Cons l4 t4
...
-- Nine
instance nineConsLimitCountNine  :: LimitCount (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Z))))))))))
  (Cons l1 t1
    (Cons l2 t2
      (Cons l3 t3
        (Cons l4 t4
...
-- Ten
instance tenConsLimitCountTen  :: LimitCount (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Z)))))))))))
  (Cons l1 t1
    (Cons l2 t2
      (Cons l3 t3
        (Cons l4 t4
